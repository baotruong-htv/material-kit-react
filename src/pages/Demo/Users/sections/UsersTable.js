  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        <UsersTableToolbar selected={selected} onDelete={onDelete} />
            ...
            <TableBody>
              {visibleRows.map((row, index) => {
                ...
                return (
                  <TableRow
                    hover
                    onClick={() => navigate(`/pages/demo/users/${row.id}`)}
                    role="checkbox"
                    ...
                    sx={{ cursor: "pointer" }}
                  >
                    <TableCell padding="checkbox" onClick={(event) => handleSelect(event, row.id)}>
                      <Checkbox
                        color="primary"
